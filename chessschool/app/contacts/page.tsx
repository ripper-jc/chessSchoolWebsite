...
export default function Contacts() {
    return (
        ...
        <div className="container mx-auto min-h-[100dvh] my-24 px-4 sm:px-6  text-center flex flex-col justify-center items-center">
            <Title title="Відточуйте свою майстерність з нами" subtitle="Подайте заявку на безкоштовне заняття " />
            <div className="container mx-auto my-24 px-4 sm:px-6 lg:px-48 grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="">
            <Image src={Contact} alt="" />
            <p className="p-4">Якщо Ви не знайшли потрібної послуги, ми завжди готові обговорити, чим можемо допомогти Вам!</p>
          </div>
          <div>
            <div>
