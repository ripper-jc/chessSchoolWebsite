          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6">
              <p className="text-lg leading-relaxed">
                ...
                шахову партію, а через півроку занять, буде брати участь у
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  досягнень шахіста. Заняття проходять онлайн, з будь-якого куточка
              ...
              <p className="text-lg leading-relaxed">
                Ми віримо, що в кожній дитині прихований чемпіон, ми допоможемо
